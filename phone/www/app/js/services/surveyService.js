...
app.service("surveyService", ['$log', '$location','surveyFactory','$rootScope','$timeout','$q', function ($log, $location,surveyFactory,$rootScope,$timeout,$q) {
...
this.getSurvey =function(){
	...
	self.getQuestionOptionsForQuestion=function(question_id){		
		$timeout(function(){		
        console.log("--------------getQuestionOptionsForQuestion---------")	;
	...
	return $q(function(resolve, reject) {
		var quest_id = eval(surveyFactory.getNextquestionId())+1;
		$timeout(function(){			
			var question_query="SELECT Id,The_question,survey_id FROM QUESTION WHERE survey_id= ? and Id = ?";
			...
			self.getQuestionOptionsForQuestion(quest_id);						
	});
	}
